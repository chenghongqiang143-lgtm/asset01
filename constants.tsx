...
export const Icons = {
  ...
  List: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  Cog: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  CategoryIcon: ({ category, className }: { category: AssetCategory, className?: string }) => {
    switch (category) {
      ...
      case AssetCategory.CRYPTO:
        return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 8v8" /><path d="M9 12h6" /></svg>;
      case AssetCategory.SAVING:
        return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 5h-1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h1" /><path d="M5 19h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5" /><circle cx="12" cy="12" r="3" /></svg>;
      case AssetCategory.LIABILITY:
        return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 9-6 6" /><path d="m9 9 6 6" /><rect width="18" height="18" x="3" y="3" rx="2" /></svg>;
      default:
